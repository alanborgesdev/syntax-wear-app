...
function RouteComponent() {
    return (
        <section className="container py-6">
            ...
            <div>
                <h1 className="text-black text-2xl max-w-7xl m-auot my-20 text-center">
                    Nossas lojas são o coração da nossa marca. Explore a coleção
                    mais recente, experimente seus modelos favoritos e sinta o
                    conforto da SyntaxWear pessoalmente.
                </h1>
                ...
                <section className="text-black w-full space-y-20">
                    <div className="flex flex-col md:flex-row items-center gap-2.5">
                        <div className="text-center py-6">
                            ...
                            <p>
                                Descubra os lançamentos da temporada antes de
                                todo mundo e experimente nossos estilos mais
                                recentes de perto.
                            </p>
                        </div>
